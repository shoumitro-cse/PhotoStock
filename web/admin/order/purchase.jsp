<%-- 
    Document   : purchase
    Created on : Jul 29, 2020, 11:22:47 AM
    Author     : shoumitro
--%>
...
<html>
    ...
    <body>
        ...
        <%
            List list = OrderInfo.getAllPurchaseItem();
            int size = list.size();
        %>
            ...
            <div class="body-content">
                ...
                <div class="body-main-container">
                    <div class="body-main-content">
                        <p class="panel-head">Total Purchase (<% out.write(size+""); %>)</p>
                        <main>
                                ...
                                <div id="tab_content_1" class="table-content">
                                    ...
                                    <table id="table_1" class="table">
                                        <caption>
                                            ...
                                            <span class="caption-text">Total Purchase</span>
                                        ...
                                        ,<thead>
                                            <tr>
                                                <th onclick="sortTable(this, 0, 'table_1')" class="th_down">purchase_item_id</th>
                                                <th onclick="sortTable(this, 1, 'table_1')" class="th_updown">order_id</th>
                                                <th onclick="sortTable(this, 2, 'table_1')" class="th_updown">image_id</th>
                                        ...
                                        <tbody>
                                            ...
                                            %>
                                            <tr>
                                                <td><% out.write(map.get("purchase_item_id").toString()); %></td>
                                                ...
                                                <td style="min-width: 0;" class="edit">
                                                    <button onclick="openDeleteAlert(<% out.write(map.get("purchase_item_id").toString()); %>)" title="delete" class="fa fa-trash"></button>
                                                </td>
                                            </tr>  
                                            <% }%>
                                        </tbody>
