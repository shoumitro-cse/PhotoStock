<%-- 
    Document   : payment
    Created on : Jul 29, 2020, 11:27:39 AM
    Author     : shoumitro
--%>
...
<html>
    ...
    <body>
        ...
        <%
            List list = OrderInfo.getAllPayment();
            int size = list.size();
        %>
            ...
            <div class="body-content">
                ...
                <div class="body-main-container">
                    <div class="body-main-content">
                        <p class="panel-head">Total Payment (<% out.write(size + ""); %>)</p>
                        <main>
                                ...
                                <div id="tab_content_1" class="table-content">
                                    ...
                                    <table id="table_1" class="table">
                                        <caption>
                                            ...
                                            <span class="caption-text">Total Payment</span>
                                        ...
                                        ,<thead>
                                            <tr>
                                                <th onclick="sortTable(this, 0, 'table_1')" class="th_down">payment_id</th>
                                                <th onclick="sortTable(this, 1, 'table_1')" class="th_updown">amount</th>
                                                <th onclick="sortTable(this, 2, 'table_1')" class="th_updown">credit_card_id</th>
                                                <th onclick="sortTable(this, 3, 'table_1')" class="th_updown">user_id</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><% out.write(map.get("amount").toString()); %></td>
                                                <td><% out.write(map.get("credit_card_id").toString()); %></td>
                                                <td><% out.write(map.get("user_id").toString()); %></td>
                                                <td style="min-width: 0;" class="edit">
                                                    <button onclick="openDeleteAlert(<% out.write(map.get("payment_id").toString()); %>)" title="delete" class="fa fa-trash"></button>
                                                </td>
                                            </tr>  
                                            <% }%>
                                        </tbody>
