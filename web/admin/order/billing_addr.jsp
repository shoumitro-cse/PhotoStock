<%-- 
    Document   : billing_addr
    Created on : Jul 29, 2020, 11:50:18 AM
    Author     : shoumitro
--%>
...
<html>
    ...
    <body>
        ...
        <%
            List list = OrderInfo.getAllBillingAddress();
            int size = list.size();
        %>
            ...
            <div class="body-content">
                ...
                <div class="body-main-container">
                    <div class="body-main-content">
                        <p class="panel-head">Billing Address </p>
                        <main>
                                ...
                                <div id="tab_content_1" class="table-content">
                                    ...
                                    <table id="table_1" class="table">
                                        <caption>
                                            ...
                                            <span class="caption-text">Billing Address</span>
                                        ...
                                        ,<thead>
                                            <tr>
                                                <th onclick="sortTable(this, 0, 'table_1')" class="th_down">billing_addr_id</th>
                                                ...
                                                <th onclick="sortTable(this, 3, 'table_1')" class="th_updown">address</th>
                                                <th onclick="sortTable(this, 4, 'table_1')" class="th_updown">city</th>
                                                <th onclick="sortTable(this, 5, 'table_1')" class="th_updown">state</th>
                                                <th onclick="sortTable(this, 6, 'table_1')" class="th_updown">zip</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><% out.write(map.get("address").toString()); %></td>
                                                ...
                                                <td style="min-width: 0;" class="edit">
                                                    <button onclick="openDeleteAlert(<% out.write(map.get("billing_addr_id").toString()); %>)" title="delete" class="fa fa-trash"></button>
                                                </td>
                                            </tr>  
                                            <% }%>
                                        </tbody>
