<%-- 
    Document   : notice
    Created on : Jul 29, 2020, 11:54:28 AM
    Author     : shoumitro
--%>
...
<html>
    ...
    <body>
        ...
        <%
            List list = OrderInfo.getAllNotice();
            int size = list.size();
        %>
                                ...
                                <div id="tab_content_1" class="table-content">
                                    ...
                                    <table id="table_1" class="table">
                                        <caption>
                                            ...
                                            <span class="caption-text"> Notice </span>
                                        ...
                                        ,<thead>
                                            <tr>
                                                <th onclick="sortTable(this, 0, 'table_1')" class="th_down">notice_id</th>
                                                <th onclick="sortTable(this, 1, 'table_1')" class="th_updown">large_msg</th>
                                                <th onclick="sortTable(this, 2, 'table_1')" class="th_updown">small_msg</th>
                                                <th onclick="sortTable(this, 3, 'table_1')" class="th_updown">notice_date</th>
                                        ...
                                        <tbody>
                                            ...
                                            %>
                                            <tr>
                                                <td><% out.write(map.get("notice_id").toString()); %></td>
                                                <td><% out.write(map.get("large_msg").toString()); %></td>
                                                <td><% out.write(map.get("small_msg").toString()); %></td>
                                                <td><% out.write(map.get("notice_date").toString()); %></td>
                                                <td><% out.write(map.get("user_id").toString()); %></td>
                                                <td style="min-width: 0;" class="edit">
                                                    <button onclick="openDeleteAlert(<% out.write(map.get("notice_id").toString()); %>)" title="delete" class="fa fa-trash"></button>
                                                </td>
                                            </tr>  
                                            <% }%>
                                        </tbody>
