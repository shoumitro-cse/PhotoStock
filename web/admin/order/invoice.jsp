<%-- 
    Document   : invoice
    Created on : Jul 29, 2020, 11:33:09 AM
    Author     : shoumitro
--%>
...
<html>
    ...
    <body>
        ...
        <%
            List list = OrderInfo.getAllInvoice();
            int size = list.size();
            List list2 = OrderInfo.getAllInvoiceHistory();
                        ...
                        <main>
                            ...
                            <div class="table-container">
                                ...
                                <div class="tab-content">
                                    <ul>
                                        <li><a class="all_time_tab_active" id="tab_bar_1" onclick="tabShow(this, 'tab_content_1', 'tab_bar_1')" href="">Invoice</a></li> 
                                        <li><a id="tab_bar_2" onclick="tabShow(this, 'tab_content_2', 'tab_bar_2')" href="">History</a></li> 
                                ...
                                <div id="tab_content_1" class="table-content">
                                    ...
                                    <table id="table_1" class="table">
                                        <caption>
                                            ...
                                            <span class="caption-text">Total Invoice (<% out.write(size + ""); %>)</span>
                                        ...
                                        ,<thead>
                                            <tr>
                                                <th onclick="sortTable(this, 0, 'table_1')" class="th_down">invoice_image_id</th>
                                                ...
                                                <th onclick="sortTable(this, 3, 'table_1')" class="th_updown">totalSaveMoney</th>
                                                <th onclick="sortTable(this, 4, 'table_1')" class="th_updown">credit_card_id</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><% out.write(map.get("credit_card_id").toString()); %></td>
                                                <td><% out.write(map.get("credit_card_id").toString()); %></td>
                                                <td><% out.write(map.get("user_id").toString()); %></td>
                                                <td style="min-width: 0;" class="edit">
                                                    <button onclick="openDeleteAlert(<% out.write(map.get("invoice_image_id").toString()); %>)" title="delete" class="fa fa-trash"></button>
                                                </td>
                                            </tr>  
                                            <% }%>
                                        </tbody>
                                ...
                                <div id="tab_content_2" class="table-content">
                                    ...
                                    <table id="table_2" class="table">
                                        <caption>
                                            ...
                                            <span class="caption-text">Invoice History (<% out.write(sizeh + ""); %>)</span>
                                            <span class="caption-select-box">
                                        ...
                                        ,<thead>
                                            <tr>
                                                <th onclick="sortTable(this, 0, 'table_2')" class="th_down">invoice_image_history_id</th>
                                                <th onclick="sortTable(this, 1, 'table_2')" class="th_updown">quantity</th>
                                                <th onclick="sortTable(this, 2, 'table_2')" class="th_updown">image_id</th>
                                                <th onclick="sortTable(this, 3, 'table_2')" class="th_updown">invoice_image_id</th>
                                                <th style="text-align: center;cursor: initial;">Actions</th>
                                            </tr>
                                        </thead>
                                        <tbody>
