<%-- 
    ...
    Created on : Jul 29, 2020, 11:38:14 AM
    Author     : shoumitro
--%>
...
<html>
    <head>
        ...
        <title> Credit card addr</title>
    </head>
    <body>

        <%
            List list = OrderInfo.getAllCreditCardAddress();
            int size = list.size();
        %>
            ...
            <div class="body-content">
                ...
                <div class="body-main-container">
                    <div class="body-main-content">
                        <p class="panel-head">Credit card address</p>
                        <main>
                                ...
                                <div id="tab_content_1" class="table-content">
                                    ...
                                    <table id="table_1" class="table">
                                        <caption>
                                            ...
                                            <span class="caption-text">Credit card address</span>
                                        ...
                                        ,<thead>
                                            <tr>
                                                <th onclick="sortTable(this, 0, 'table_1')" class="th_down">credit_card_id</th>
                                                ...
                                                <th onclick="sortTable(this, 4, 'table_1')" class="th_updown">exp_year</th>
                                                <th onclick="sortTable(this, 5, 'table_1')" class="th_updown">cvv</th>
                                                <th onclick="sortTable(this, 6, 'table_1')" class="th_updown">billing_addr_id</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><% out.write(map.get("exp_year").toString()); %></td>
                                                <td><% out.write(map.get("cvv").toString()); %></td>
                                                <td><% out.write(map.get("billing_addr_id").toString()); %></td>
                                                <td><% out.write(map.get("user_id").toString()); %></td>
                                                <td style="min-width: 0;" class="edit">
                                                    <button onclick="openDeleteAlert(<% out.write(map.get("credit_card_id").toString()); %>)" title="delete" class="fa fa-trash"></button>
                                                </td>
                                            </tr>  
                                            <% }%>
                                        </tbody>
