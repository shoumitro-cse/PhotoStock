<%-- 
    Document   : all
    Created on : Jul 29, 2020, 12:08:34 AM
    Author     : shoumitro
--%>
            ...
            <div class="body-content">
                ...
                <div class="body-main-container">
                    <div class="body-main-content">
                        <p class="panel-head">All User (<% out.write(size+""); %>)</p>
                        <main>
                            ...
                            <div class="table-container">
                                ...
                                <div class="tab-content">
                                    <ul>
                                        <li><a class="all_time_tab_active" id="introduct_tab_id" onclick="tabShow(this, 'simple_inroduction', 'introduct_tab_id')" href="">Table</a></li> 
                                ...
                                <div id="simple_inroduction" class="table-content">
                                    ...
                                    <table id="table_1" class="table">
                                        <caption>
                                            ...
                                            <span class="caption-text">All user</span>
                                        ...
                                        ,<thead>
                                            <tr>
                                                ...
                                                <th onclick="sortTable(this, 3, 'table_1')" class="th_updown">Email</th>
                                                <th onclick="sortTable(this, 4, 'table_1')" class="th_updown">Password</th>
                                                <th onclick="sortTable(this, 5, 'table_1')" class="th_updown">Re_type_password</th>
                                                <th onclick="sortTable(this, 6, 'table_1')" class="th_updown">picture_url</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="min-width: 0;" class="edit">
                                                    <button onclick="openDeleteAlert(<% out.write(map.get("user_id").toString()); %>)" title="delete" class="fa fa-trash"></button>
                                                </td>
                                            </tr>  
                                            <% }%>
