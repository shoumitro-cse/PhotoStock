<%-- 
    Document   : user_count
    Created on : Jul 30, 2020, 10:14:35 AM
    Author     : shoumitro
--%>
...
<html>
    <head>
        ...
        <title>Visited Users Count</title>
    </head>
    <body>

        <%
            List list = Chart.getAllVisitedUserCount();
            int size = list.size();
        %>
            ...
            <div class="body-content">
                ...
                <div class="body-main-container">
                    <div class="body-main-content">
                        <p class="panel-head">Today Visitors(<% out.write(size + "");%>)</p>
                        <main>
                                ...
                                <div id="tab_content_1" class="table-content">
                                    ...
                                    <table id="table_1" class="table">
                                        <caption>
                                            ...
                                            <span class="caption-text">Visitor Count</span>
                                        ...
                                        ,<thead>
                                            ...
                                            <tr>
                                                <th onclick="sortTable(this, 0, 'table_1')" class="th_down">visited_users_count_id</th>
                                                <th onclick="sortTable(this, 1, 'table_1')" class="th_updown">user_id</th>
                                                <th onclick="sortTable(this, 2, 'table_1')" class="th_updown">fullname</th>
                                        ...
                                        <tbody>
                                            ...
                                            %>
                                            <tr>
                                                <td><% out.write(map.get("visited_users_count_id").toString()); %></td>
                                                ...
                                                <td style="min-width: 0;" class="edit">
                                                    <button onclick="openDeleteAlert(<% out.write(map.get("visited_users_count_id").toString()); %>)" title="delete" class="fa fa-trash"></button>
                                                </td>
                                            </tr>  
                                            <% }%>
                                        </tbody>
