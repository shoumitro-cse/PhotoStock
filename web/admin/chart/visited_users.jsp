<%-- 
    Document   : visited_users
    Created on : Jul 30, 2020, 10:13:57 AM
    Author     : shoumitro
--%>
...
<html>
    ...
    <body>
        ...
        <%
            List list = Chart.getAllVisitedUsersChart();
            int size = list.size();
        %>
            ...
            <div class="body-content">
                ...
                <div class="body-main-container">
                    <div class="body-main-content">
                        <p class="panel-head">Total User Visit (<% out.write(size + ""); %> day)</p>
                        <main>
                                ...
                                <div id="tab_content_1" class="table-content">
                                    ...
                                    <table id="table_1" class="table">
                                        <caption>
                                            ...
                                            <span class="caption-text">Visited Users</span>
                                        ...
                                        ,<thead>
                                            ...
                                            <tr>
                                                <th onclick="sortTable(this, 0, 'table_1')" class="th_down">visited_users_chart_id</th>
                                                <th onclick="sortTable(this, 1, 'table_1')" class="th_updown">visited_users_count</th>
                                                <th onclick="sortTable(this, 2, 'table_1')" class="th_updown">date</th>
                                                <th onclick="sortTable(this, 3, 'table_1')" class="th_updown">date_time</th>
                                        ...
                                        <tbody>
                                            ...
                                            %>
                                            <tr>
                                                <td><% out.write(map.get("visited_users_chart_id").toString()); %></td>
                                                <td><% out.write(map.get("visited_users_count").toString()); %></td>
                                                <td><% out.write(map.get("date").toString()); %></td>
                                                <td><% out.write(map.get("date_day").toString()); %></td>
                                                <td style="min-width: 0;" class="edit">
                                                    <button onclick="openDeleteAlert(<% out.write(map.get("visited_users_chart_id").toString()); %>)" title="delete" class="fa fa-trash"></button>
                                                </td>
                                            </tr>  
                                            <% }%>
                                        </tbody>
